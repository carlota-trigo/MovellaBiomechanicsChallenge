...
file_name = "C:/Users/Carlota/Desktop/Case Study Kit/Recordings/P3/MVNX/medium_round.mvnx"
...
def main(file_name):
    ...
    my_dict1 = mvnx_file.get_center_of_mass_acc

    # Open a file in binary mode
    with open("my_dict1.pickle", "wb") as f:
        # Dump the dictionary variable to the file using pickle.dump
    ...
    segment_pos = mvnx_file.get_data('segment_data', 'pos', 0)
    '''
    if segment_pos:
